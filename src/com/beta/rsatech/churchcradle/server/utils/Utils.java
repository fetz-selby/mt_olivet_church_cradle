...
public class Utils {
	...
	public static String getEndDate(String delimiter, String date){
		int numberOfDays = 31;
		String[] tokens = date.split(delimiter);
		String month = tokens[0];
		String year = tokens[1];

		if(month.equals(AppConstants.JAN)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.FEB)){
			numberOfDays = 29;
		}else if(month.equals(AppConstants.MAR)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.APR)){
			numberOfDays = 30;
		}else if(month.equals(AppConstants.MAY)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.JUN)){
			numberOfDays = 30;
		}else if(month.equals(AppConstants.JUL)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.AUG)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.SEP)){
			numberOfDays = 30;
		}else if(month.equals(AppConstants.OCT)){
			numberOfDays = 31;
		}else if(month.equals(AppConstants.NOV)){
			numberOfDays = 30;
		}else if(month.equals(AppConstants.DEC)){
			numberOfDays = 31;
		}

		return  year+"-"+month+"-"+numberOfDays;
	}
	...
	public static String getMonthInWords(String month){
		if(month.trim().equalsIgnoreCase(AppConstants.JAN) || month.trim().equalsIgnoreCase("1")){
			return AppConstants.JANUARY;
		}else if(month.trim().equalsIgnoreCase(AppConstants.FEB) || month.trim().equalsIgnoreCase("2")){
			return AppConstants.FEBUARY;
		}else if(month.trim().equalsIgnoreCase(AppConstants.MAR) || month.trim().equalsIgnoreCase("3")){
			return AppConstants.MARCH;
		}else if(month.trim().equalsIgnoreCase(AppConstants.APR) || month.trim().equalsIgnoreCase("4")){
			return AppConstants.APRIL;
		}else if(month.trim().equalsIgnoreCase(AppConstants.MAY) || month.trim().equalsIgnoreCase("5")){
			return AppConstants.MAYW;
		}else if(month.trim().equalsIgnoreCase(AppConstants.JUN) || month.trim().equalsIgnoreCase("6")){
			return AppConstants.JUNE;
		}else if(month.trim().equalsIgnoreCase(AppConstants.JUL) || month.trim().equalsIgnoreCase("7")){
			return AppConstants.JULY;
		}else if(month.trim().equalsIgnoreCase(AppConstants.AUG) || month.trim().equalsIgnoreCase("8")){
			return AppConstants.AUGUST;
		}else if(month.trim().equalsIgnoreCase(AppConstants.SEP) || month.trim().equalsIgnoreCase("9")){
			return AppConstants.SEPTEMBER;
		}else if(month.trim().equalsIgnoreCase(AppConstants.OCT)){
			return AppConstants.OCTOBER;
		}else if(month.trim().equalsIgnoreCase(AppConstants.NOV)){
			return AppConstants.NOVEMBER;
		}else if(month.trim().equalsIgnoreCase(AppConstants.DEC)){
