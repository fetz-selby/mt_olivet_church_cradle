...
public class CheckTokenWidget extends Composite {
	private boolean isChecked;
	private GroupInfoModel model;
	private CheckTokenWidgetEventHandler handler;
	...
	UiBinder<Widget, CheckTokenWidget> {
	}
	...
	public interface CheckTokenWidgetEventHandler{
	...
	public CheckTokenWidget(GroupInfoModel model) {
		this.model = model;
	...
	public void setCheckTokenWidgetEventHandler(CheckTokenWidgetEventHandler handler){
